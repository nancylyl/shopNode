...
const indexdao = {
    ...
    getMyOder(req, resp) {
        ...
        WHERE Uid=${UId}  ${datawhere}  GROUP BY ordernum,State,CreateDate,New_Name ;`
        console.log(sql);
        db.connect(sql, [], (err, data) => {
            result = new Result();
            if (err == null) {
    ...
    `;
        ...
        //         );`
        // }
        // sql += `    UPDATE s_userinfo SET SumScore=SumScore+${totalScore}-${jfScore} WHERE UId=${UId} ;`
        // console.log(sql);
